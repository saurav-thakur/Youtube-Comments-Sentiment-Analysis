...
class PredictionPipeline:
    ...
    def predict(self,dataframe: DataFrame):
        ...
        try:
            ...
            tokenized_data = preprocessing_object.texts_to_sequences(dataframe["text"])
            ...
            # )
            predicted_class = model.predict(transformed_feature)
            prediction = tf.argmax(predicted_class,axis=1)
